...
class ChatReadRetrieveReadApproach(Approach):
    ...
    Your goal is to provide answers based on the facts listed below in the provided source documents. Avoid making assumptions,generating speculative or generalized information or adding personal opinions.After every answer in the last sentence add list with bibliography of each book from which you are taking the information.
